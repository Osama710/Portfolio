  ...
  return (
    <section id="education" className="site-section relative">
      <div className="site-container overflow-visible">
        ...
        <div className="section-reveal edu-reveal mt-8 grid gap-6 lg:grid-cols-12 lg:gap-8">
          <div className="scroll-reveal-item lg:col-span-5">
            <div className="panel-vivid edu-degree-panel h-full">
              ...
              {education.map((item) => (
                <div key={item.degree} className="mt-6 flex-1">
                  ...
                  <h3 className="mt-2 font-display text-2xl font-bold text-ink">{item.degree}</h3>
          ...
          <div className="scroll-reveal-item lg:col-span-7">
            <div className="panel-hud edu-cert-panel h-full p-7">
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-2">
                {certifications.map((cert) => (
                  <div
                    key={cert.title}
                    className="edu-cert-card flex gap-3 rounded-2xl border border-white/[0.06] bg-void/40 p-4 transition-colors hover:border-accent-coral/30"
                  >
              ...
              <div className="edu-footnote mt-8 flex items-center gap-2 rounded-2xl bg-gradient-brand-soft px-4 py-3 text-sm text-ink-muted">
