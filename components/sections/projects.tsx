...
const tagThemes: Record<string, { accent: string; glow: string; gradient: string; emoji: string }> =
  {
    Fintech: {
      accent: "#F47298",
      glow: "rgba(244, 114, 152, 0.32)",
      gradient: "linear-gradient(135deg, #F47298, #8B5CF6)",
      emoji: "💳",
    },
    "E-commerce": {
      accent: "#8B5CF6",
    ...
    Marketing: {
      accent: "#F47298",
      glow: "rgba(244, 114, 152, 0.28)",
      gradient: "linear-gradient(135deg, #F47298, #6366F1)",
      emoji: "📣",
    },
    Food: {
      accent: "#FBBF24",
      glow: "rgba(251, 191, 36, 0.22)",
      gradient: "linear-gradient(135deg, #FBBF24, #F47298)",
      emoji: "🍽️",
    },
    "Open Source": {
      accent: "#22D3EE",
